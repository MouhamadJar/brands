...
var userController = Get.put(USERModel());
          ...
          cacheController.saveCache(key: 'image', value: 'https://cdn5.vectorstock.com/i/thumb-large/45/79/male-avatar-profile-picture-silhouette-light-vector-4684579.jpg');
        } catch (e) {
          print('err\n' + e.toString());
        }
      });
        ...
        Fluttertoast.showToast(
            msg: 'Something went wrong !', backgroundColor: Colors.red,gravity: ToastGravity.BOTTOM);
      });
  }
