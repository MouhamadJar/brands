          ...
          Row(
            children: [
              ...
              Brand(
                width: width*.5,
                height: height,
                brandImage: 'images/Apple-Logo.png',
                onTap: () {
                  Get.to( () =>const BrandMobiles(brand: 'a'));
                },
                splash: Colors.grey.withOpacity(0.4),
                highlight: Colors.grey.withOpacity(0.35),
              ),
            ],
          ),
          Brand(
            width: width,
            height: height,
            brandImage: 'images/Sony-Logo.png',
            onTap: () {
              Get.to( () =>const BrandMobiles(brand: 'so'));
            },
            splash: Colors.blueGrey.withOpacity(0.4),
            highlight: Colors.blueGrey.withOpacity(0.35),
          ),
        ],
      ),
    );
