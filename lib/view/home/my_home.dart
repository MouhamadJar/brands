                  ...
                  child: Center(
                    child: ListView.builder(
                      ...
                      itemCount: controller
                          .latestSamsungItem.isEmpty
                          ? 1
                          : controller.latestSamsungItem.length >=
                          5
                          ? 5
                          : controller
                          .latestSamsungItem.length,
                    ),
                  ),
                );
              }),
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          AnimatedContainer(
                            ...
                            width:
                            controller.xiaomiItemsIsLoading.value
                                ? width * .1
                                : width,
                            height:
                            controller.xiaomiItemsIsLoading.value
                      ...
                      itemCount: controller
                          .latestXiaomiItem.isEmpty
                          ? 1
                          : controller.latestXiaomiItem.length >=
                          5
                          ? 5
                          : controller
                          .latestXiaomiItem.length,
                    ),
                  ),
                );
              }),
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          AnimatedContainer(
                            ...
                            width:
                            controller.realmeItemsIsLoading.value
                                ? width * .1
                                : width,
                            height:
                            controller.realmeItemsIsLoading.value
                      ...
                      itemCount: controller
                          .latestRealmeItem.isEmpty
                          ? 1
                          : controller.latestRealmeItem.length >=
                          5
                          ? 5
                          : controller
                          .latestRealmeItem.length,
                    ),
                  ),
                );
              }),
